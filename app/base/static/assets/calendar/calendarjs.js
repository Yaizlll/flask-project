 ...
 * @property    {string}    addEventTooltipText                         The tooltip text that should be used for for the "Ajouter Evénement" button.
 ...
 * @property    {string}    fromText                                    The text that should be displayed for the "De:" label.
 * @property    {string}    toText                                      The text that should be displayed for the "To:" label.
 * @property    {string}    isAllDayEventText                           The text that should be displayed for the "Est un évenement sur toute la journée" label.
 ...
 * @property    {string}    cancelText                                  The text that should be displayed for the "Annuler" button.
 * @property    {string}    removeEventText                             The text that should be displayed for the "Supprimer Evénement" button.
 * @property    {string}    addEventTitle                               The title bar text that is shown for the "Ajouter Evénement" label.
 * @property    {string}    editEventTitle                              The title bar text that is shown for the "Modifier Evénement" label.
 * @property    {string}    monthNames                                  The names to use for months (defaults to '[ "Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Decembre" ]').
 ...
 * @property    {string}    fromTimeErrorMessage                        The error message shown for the "Please select a valid 'De' time." label.
 * @property    {string}    toTimeErrorMessage                          The error message shown for the "Please select a valid 'To' time." label.
 * @property    {string}    toSmallerThanFromErrorMessage               The error message shown for the "Please select a 'To' date that is larger than the 'De' date." label.
...
function calendarJs( id, options, startDateTime ) {
    ...
    this.setOptions = function( newOptions ) {
        ...
        if ( !isDefined( _options.addEventTooltipText ) ) {
            _options.addEventTooltipText = "Ajouter Evénement";
        }
        ...
        if ( !isDefined( _options.isAllDayEventText ) ) {
            _options.isAllDayEventText = "Est un évenement sur toute la journée";
        }
        ...
        if ( !isDefined( _options.removeEventText ) ) {
            _options.removeEventText = "Supprimer Evénement";
        }

        if ( !isDefined( _options.addEventTitle ) ) {
            _options.addEventTitle = "Ajouter Evénement";
        }

        if ( !isDefined( _options.editEventTitle ) ) {
            _options.editEventTitle = "Modifier Evénement";
        }
        ...
        if ( !isDefined( _options.fromTimeErrorMessage ) ) {
            _options.fromTimeErrorMessage = "Please select a valid 'De' time.";
        }
        ...
        if ( !isDefined( _options.toSmallerThanFromErrorMessage ) ) {
            _options.toSmallerThanFromErrorMessage = "Please select a 'To' date that is larger than the 'De' date.";
        }
